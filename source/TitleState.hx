...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		bon = new FlxSprite().loadGraphic(Paths.image('thechiefFUNKINamongus'));
		bon.setGraphicSize(Std.int(bon.width * 1.4),Std.int(bon.height * 1.4));
		bon.updateHitbox();
		bon.screenCenter();
		bon.antialiasing = ClientPrefs.globalAntialiasing;
		add(bon);
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.55).loadGraphic(Paths.image('YOITUSBOYS'));
		ngSpr.visible = false;
	...
	/*
	function squad(poopy) 
	{
		if (poopy == true) 
		{
			squadSpr.visible = true;
		} 
		else 
		{
			squadSpr.visible = false;
		}
	}*/
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['watch'], 150);
				case 7:
					addMoreText('the chief among us', 150);
					//credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
				// credTextShit.visible = false;
				...
				// credTextShit.screenCenter();
				case 9:
					createCoolText([curWacky[0]], 150);
				// credTextShit.visible = true;
				case 11:
					addMoreText(curWacky[1], 150);
				// credTextShit.text += '\nlmao';
				case 12:
					deleteCoolText();
				// credTextShit.visible = false;
				...
				// credTextShit.screenCenter();
				case 13:
					addMoreText('Friday', 150);
				// credTextShit.visible = true;
				case 14:
					addMoreText('Night', 150);
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Funkin', 150); // credTextShit.text += '\nFunkin';
